...
| `train_surrogate_model.py` | **Superseded** | Trained XGBoost on synthetic damage of 1L2Y with graph-topology features. The shipped bundle (`models/COSMORA_mock_model_bundle.pkl`) replaces it, and this project does not retrain. |
